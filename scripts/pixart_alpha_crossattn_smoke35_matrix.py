...
DATE_TAG = "20260329"
RESULT_ROOT = PIXART_ROOT / "results" / f"cross_attn_smoke35_matrix_{DATE_TAG}"
...
BASE_ATTACK_ARGS = {
    ...
    "is_encoder": 1,
    "encoder_weights": str(REPO_ROOT / "checkpoints" / "Controlvae.pt"),
...
RUN_SPECS = {
    "E": {
        "run_id": f"pixart_crossattn_surE_{DATE_TAG}",
        "record_id": f"pixart_crossattn_smoke35_surE_{DATE_TAG}",
        "model_name": "E,R,D,S",
        "compared_to": "pixart_noctrl_700_surE|pixart_selfattn_smoke35_surE_g1p0_20260328|pixart_crossattn_smoke35_surS_20260326",
    },
    "R": {
        "run_id": f"pixart_crossattn_surR_{DATE_TAG}",
        "record_id": f"pixart_crossattn_smoke35_surR_{DATE_TAG}",
        "model_name": "R,E,D,S",
        "compared_to": "pixart_noctrl_700_surR|pixart_selfattn_smoke35_surR_g1p0_20260328|pixart_crossattn_smoke35_surS_20260326",
    },
    "D": {
        "run_id": f"pixart_crossattn_surD_{DATE_TAG}",
        "record_id": f"pixart_crossattn_smoke35_surD_{DATE_TAG}",
        "model_name": "D,E,R,S",
        "compared_to": "pixart_noctrl_700_surD|pixart_selfattn_smoke35_surD_g1p0_20260328|pixart_crossattn_smoke35_surS_20260326",
    },
    "S": {
        "run_id": f"pixart_crossattn_surS_{DATE_TAG}",
        "record_id": f"pixart_crossattn_smoke35_surS_{DATE_TAG}",
        "model_name": "S,E,R,D",
        "compared_to": "pixart_noctrl_700_surS|pixart_selfattn_smoke35_surS_g1p0_20260326|pixart_crossattn_smoke35_surS_20260326",
    },
}
...
def output_dataroot(surrogate: str) -> Path:
    return ATTACK_DATASETS_ROOT / f"PixArtAlpha_smoke35_adv_cross_sur{surrogate}_{DATE_TAG}"
...
def run_attack(surrogate: str) -> None:
    ...
    write_json(
        out_dir / "run_meta.json",
        {
            ...
            "problem": "Complete the PixArt cross-attn smoke35 surrogate matrix for visual-quality-oriented follow-up.",
            "pipeline": [
                "PixArt transformer backbone",
                "DDIM inversion startpoint",
                "cross-attn regularization on representative attn2 layers",
                "LAO latent optimization",
                "export transfer / visual / frequency metrics",
            ],
            "candidate_modules": {
                "enabled": ["PixArtAlpha transformer", "cross-attn regularizer"],
